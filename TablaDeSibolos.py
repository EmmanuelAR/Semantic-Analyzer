...
class TablaDeSimbolos:
    ...
    def __init__(self):
        ...
        self.FormatLines = ([]) #vector para guadar las lineas con formato

    #   Este metodo se encarga de recibir la ruta del archivo y recorrer linea por linea para
    #   asi poder almacenarlo para su analisis,se eliminan los tabs y los endl
    ...
    def mostrarAnalisis(self):
        for i in range(len(self.FormatLines)):
            if i < 9:
                print(str(i + 1) + " |  " + self.FormatLines[i])
            else:
                print(str(i + 1) + "|  " + self.FormatLines[i])
        print()
